  ...
  return (
    <main className="min-h-screen bg-slate-950 text-slate-100 p-6 md:p-12">
      <div className="mx-auto max-w-7xl space-y-8">
        ...
        <div>
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-slate-800 pb-6">
            ...
            <div className="flex flex-wrap items-center gap-4">
              {/* Severity Badge */}
              <div className="flex flex-col items-end rounded-xl bg-slate-900 border border-slate-800 px-4 py-2">
        ...
        <div className="rounded-2xl border border-cyan-500/30 bg-gradient-to-r from-cyan-950/40 via-slate-900 to-indigo-950/40 p-6 md:p-8 shadow-2xl relative overflow-hidden">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              {selectedSegment ? (
                <span className="inline-flex items-center gap-1.5 rounded-full bg-cyan-950 px-3 py-1 text-xs font-bold text-cyan-300 border border-cyan-800">
          ...
          {tsLoading ? (
            <div className="flex h-96 items-center justify-center rounded-xl bg-slate-900 border border-slate-800 text-slate-400 font-medium animate-pulse">
